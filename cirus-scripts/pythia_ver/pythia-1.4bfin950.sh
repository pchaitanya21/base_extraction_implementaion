...
# Run the main script
python main_load_input10000swa950.py --N 10000 --batch-size 10 --model1 /work/tc062/tc062/s2605274/models/pythia-160m --model2 /work/tc062/tc062/s2605274/models/pythia-160m --corpus-path swa_sample.txt --name-tag pythia160swa950
