...
# Run the main script
python main_load_input10000fin.py --N 10000 --batch-size 10 --model1 /work/tc062/tc062/s2605274/models/gpt-neo-1.3B --model2 /work/tc062/tc062/s2605274/models/gpt-neo-1.3B --corpus-path fin_sample.txt --name-tag gptneo125mfin
