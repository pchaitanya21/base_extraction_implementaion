...
# Run the main script
python main_load_input10000swa.py --N 10000 --batch-size 10 --model1 /work/tc062/tc062/s2605274/models/gpt-neo-125m --model2 /work/tc062/tc062/s2605274/models/gpt-neo-125m --corpus-path swa_sample.txt --name-tag gptneo125m10kswa
