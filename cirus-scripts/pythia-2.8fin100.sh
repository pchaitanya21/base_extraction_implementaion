...
# Run the main script
python main_load_input10000finp.py --N 10000 --batch-size 5 --model1 /work/tc062/tc062/s2605274/models/pythia-2.8b --model2 /work/tc062/tc062/s2605274/models/pythia-2.8b --corpus-path fin_sample.txt --name-tag pythia2.8fin100
