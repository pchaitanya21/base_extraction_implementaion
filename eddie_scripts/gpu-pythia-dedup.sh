...
#$ -o /exports/eddie/scratch/s2605274/job_runs/EDDIE-pythia-2.8bdedup_$JOB_ID.log
#$ -e /exports/eddie/scratch/s2605274/job_runs/EDDIE-pythia-2.8bdedup_$JOB_ID.err
#$ -cwd
