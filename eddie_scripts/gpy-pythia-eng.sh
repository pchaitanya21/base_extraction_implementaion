...
#$ -N Pythia-eng-cc-2.8b-150
#$ -o /exports/eddie/scratch/s2605274/job_runs/EDDIE-pythia-eng1.4_$JOB_ID.log
#$ -e /exports/eddie/scratch/s2605274/job_runs/EDDIE-pythia-eng1.4_$JOB_ID.err
#$ -cwd
...
# Run the main script
python main_load_input10000eng.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-2.8b --model2 EleutherAI/pythia-1.4b --corpus-path monology/pile-uncopyrighted --name-tag pythia2.8b+1.4bppx_run2_engcc150
