...
# Run the main script
python main_load_input10000eng.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-1.4b --model2 EleutherAI/pythia-160m --corpus-path monology/pile-uncopyrighted --name-tag pythia160mengcc150
