...
#$ -N Pythia-Swa-KING
#$ -o /exports/eddie/scratch/s2605274/job_runs/EDDIE-pythia-6.9b_$JOB_ID.log
#$ -e /exports/eddie/scratch/s2605274/job_runs/EDDIE-pythia-6.9b_$JOB_ID.err
#$ -cwd
#$ -q gpu
#$ -pe gpu 1
#$ -l h_vmem=500G
...
# Run the main script
python main_load_input10000eng.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-2.8b --model2 EleutherAI/pythia-2.8b --corpus-path monology/pile-uncopyrighted --name-tag pythia2.8beng150
