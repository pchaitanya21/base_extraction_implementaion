...
# Run the main script
python main_load_input10000swa.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-2.8b --model2 EleutherAI/pythia-1.4b --corpus-path swa_sample.txt --name-tag pythia1.4bswa150
