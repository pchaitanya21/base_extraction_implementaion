...
# Run the main script
python main_load_input10000fin.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-6.9b --model2 EleutherAI/pythia-6.9b --corpus-path fin_sample.txt --name-tag pythia6.9fin
