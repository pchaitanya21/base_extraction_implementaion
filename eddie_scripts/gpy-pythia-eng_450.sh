...
# Run the main script
python main_load_input10000eng_450.py --N 10000 --batch-size 10 --model1 EleutherAI/pythia-1.4b --model2 EleutherAI/pythia-1.4b --corpus-path monology/pile-uncopyrighted --name-tag pythia1.4cceng50
